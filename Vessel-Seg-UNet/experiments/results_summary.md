# 预实验报告(DIAS 开源于集)—— 非最终数据

> ⚠️ **说明**:本报告对应的是**预实验阶段**使用的 DIAS 开源于集(50 对)。
> 项目正式使用的**完整数据集**是后来加入的 177 对自有标注数据,其正式实验报告见
> [RESULTS.md](RESULTS.md),完整指标总表见 [metrics_all.csv](metrics_all.csv)。
